...
public class RepositorioLinhaDigitavel {
    ...
    public boolean inserirBoletoPorLinhaDigitavel(Boleto boleto) throws SQLException {
        // SQL para verificar a existência do boleto pelo código de barras e seus status/informações
        ...
        // SQL para INSERIR um novo boleto (todas as colunas necessárias para um boleto de linha digitável)
        // Atualizado: 'suspeito' no lugar de 'denunciado', adicionado 'total_atualizacoes'
        String insertSql = "INSERT INTO Boleto (" +
                           ...
                           "suspeito, usuario_id, informacoes_confirmadas_pelo_usuario, " + // 'suspeito' aqui
                           "status_validacao_banco, nome_banco_api, nome_completo_banco_api, ispb_banco_api, " +
                           "razao_social_api, nome_fantasia_api, total_atualizacoes" + // 'total_atualizacoes' aqui
        ...
        String updateSql = "UPDATE Boleto SET " +
                           ...
                           "suspeito = ?, usuario_id = ?, informacoes_confirmadas_pelo_usuario = ?, " + // 'suspeito' aqui
                           "status_validacao_banco = ?, nome_banco_api = ?, nome_completo_banco_api = ?, ispb_banco_api = ?, " +
                           "razao_social_api = ?, nome_fantasia_api = ?, total_atualizacoes = total_atualizacoes + 1 " + // NOVO: Incrementa o contador
                           "WHERE codigo_barras = ?";
        ...
        try (Connection conexao = ConexaoBD.getConexao()) {
            ...
            try (PreparedStatement checkStmt = conexao.prepareStatement(checkSql)) {
                ...
                if (rs.next()) {
                    ...
                    System.out.println("Boleto com codigo de barras '" + boleto.getCodigoBarras() + "' ja existe.");
                    ...
                    System.out.println("Informacoes Confirmadas pelo Usuario (atual): " + infoConfirmadasExistente + ".");
                    ...
                    boolean precisaAtualizar =
                            ...
                            (boleto.getValorAsBigDecimal() != null && (valorExistente == null || !valorExistente.equals(boleto.getValorAsBigDecimal()))) ||
                            (boleto.getVencimento() != null && (vencimentoExistente == null || !vencimentoExistente.equals(boleto.getVencimento()))) ||
                            (boleto.getCnpjEmitente() != null && (cnpjEmitenteExistente == null || !cnpjEmitenteExistente.equals(boleto.getCnpjEmitente()))) ||
                            (boleto.getNomeBeneficiario() != null && (nomeBeneficiarioExistente == null || !nomeBeneficiarioExistente.equals(boleto.getNomeBeneficiario()))) ||
                            (boleto.getBancoEmissor() != null && (bancoEmissorExistente == null || !bancoEmissorExistente.equals(boleto.getBancoEmissor()))) ||
                            (boleto.getNomeBancoApi() != null && (nomeBancoApiExistente == null || !nomeBancoApiExistente.equals(boleto.getNomeBancoApi()))) ||
                            (boleto.getNomeCompletoBancoApi() != null && (nomeCompletoBancoApiExistente == null || !nomeCompletoBancoApiExistente.equals(boleto.getNomeCompletoBancoApi()))) ||
                            (boleto.getIspbBancoApi() != null && (ispbBancoApiExistente == null || !ispbBancoApiExistente.equals(boleto.getIspbBancoApi()))) ||
                            (boleto.getRazaoSocialApi() != null && (razaoSocialApiExistente == null || !razaoSocialApiExistente.equals(boleto.getRazaoSocialApi()))) ||
                            (boleto.getNomeFantasiaApi() != null && (nomeFantasiaApiExistente == null || !nomeFantasiaApiExistente.equals(boleto.getNomeFantasiaApi()))) ||
